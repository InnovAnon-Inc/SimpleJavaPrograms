...
/**
 * The test class NumericalComparisonTest.
 * @see com.innovanon.sjp.letter_grade.NumericalComparison
 */
public class NumericalComparisonTest {
	@Test (expected=IllegalArgumentException.class)
    public void testGetLetterGrade_negative () {
		com.innovanon.sjp.letter_grade.NumericalComparison t = new com.innovanon.sjp.letter_grade.NumericalComparison ();
